export default {
  ...
  'playground.system.modules.title': 'システム指示モジュール',
  'playground.system.modules.new': '新規モジュール',
  'playground.system.modules.untitled': '無題',
  'playground.system.modules.collapseAll': 'すべて折りたたむ',
  'playground.system.modules.expandAll': 'すべて展開',
  'playground.system.modules.preview': 'プレビュー',
  'playground.system.modules.chars': '文字数',
  'playground.system.modules.tokens': 'トークン ~',
  'playground.system.modules.history': '履歴',
  'playground.system.modules.history.images': '画像',
  'playground.system.modules.history.audio': '音声',
  'playground.system.modules.moveUp': '上へ移動',
  'playground.system.modules.moveDown': '下へ移動',
  'playground.system.modules.import.success': 'モジュールをインポートしました',
  'playground.system.modules.import.invalid': 'モジュールファイルが不正です',
  ...
  'playground.presets.title': 'プリセット',
  'playground.presets.placeholder': 'プリセット名',
  'playground.presets.load': '読み込み',
  'playground.presets.saved': 'プリセットを保存しました',
  'playground.presets.loaded': 'プリセットを読み込みました',
  'playground.presets.missing': 'プリセットが見つかりません',
  'playground.presets.empty': 'プリセット名を入力してください',
